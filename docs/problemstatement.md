...
- Limit the corpus to the following 5 specific scheme URLs:
  1. https://groww.in/mutual-funds/hdfc-mid-cap-fund-direct-growth
  2. https://groww.in/mutual-funds/hdfc-small-cap-fund-direct-growth
  3. https://groww.in/mutual-funds/hdfc-large-cap-fund-direct-growth
  4. https://groww.in/mutual-funds/hdfc-defence-fund-direct-growth
  5. https://groww.in/mutual-funds/hdfc-gold-etf-fund-of-fund-direct-plan-growth
...
- **README Document**
  ...
  - Known limitations
- **Technology Stack**
  - **LLM Provider**: Groq API (`llama-3.3-70b-versatile`) for ultra-fast inference
